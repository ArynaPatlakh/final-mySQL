...
if ($result->num_rows > 0) {
    ...
    // Fetch comments
    $comments_sql = "SELECT * FROM Comments WHERE film_id = $film_id";
...
<main>
 ...
 <div class="container film-detail">
    <a href="./films.php" class="btn-back">&#8617; Go Back</a>
    <h1 class="fd-main-title"><?php echo htmlspecialchars($film['title']); ?></h1>
 <p class="fd-year"><?php echo htmlspecialchars($film['film_year']); ?></p>
 <div class="container ">
    <div class="fd-wrapper-main-desc">
    <p class="fd-desc"><?php echo htmlspecialchars($film['full_description']); ?></p>
    <div class="fd-wrapper-main-rait">
    <img class="fd-img" src="<?php echo htmlspecialchars($film['image_path']); ?>" alt="<?php echo htmlspecialchars($film['title']); ?>" /> 
    <p class="fd-raiting"> <span class="fd-raiting-span">Raiting: </span><?php echo htmlspecialchars($film['rating']); ?>/10 IMDb</p>
    </div>
    </div>
 ...
 <h3 class="fd-video-title">Watch Trailer</h3>
     ...
     <iframe width="100%" height="600px" src="<?php echo htmlspecialchars($film['url_video']); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
     <p class="fd-video-desc">Full movie you can watch <a target="_blank" href="<?php echo htmlspecialchars($film['full_video']); ?>">&#8594; HERE &#8592;</a></p>
 </div>
 ...
 <div class="container fd-wrapper-comments">
  <h3 class="fd-leave-comments-title">Leave a Comment</h3>
    <form class="fd-form" action="submit_comment.php" method="post">
